...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>GRY Plane | Landing, Corporate &amp; Business Templatee</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img class="d-inline-block" src="assets/img/gallery/logo.png" width="50" alt="logo" /><span class="fw-bold text-primary ms-2">GRY Plane</span></a>
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto pt-2 pt-lg-0 font-base">
              <li class="nav-item px-2"><a class="nav-link fw-medium active" aria-current="page" href="#destinations"><span class="nav-link-icon text-800 fas fa-map-marker-alt"></span><span class="nav-link-text">Locations </span></a></li>
              <li class="nav-item px-2"><a class="nav-link" href="#flights"> <span class="nav-link-icon text-800 fas fa-plane"></span><span class="nav-link-text">Flights</span></a></li>
              <li class="nav-item px-2"><a class="nav-link" href="#hotels"> <span class="nav-link-icon text-800 fas fa-hotel"></span><span class="nav-link-text">Hotels</span></a></li>
              <li class="nav-item px-2"><a class="nav-link" href="#activities"><span class="nav-link-icon text-800 fas fa-bolt"></span><span class="nav-link-text">Activities</span></a></li>
            </ul>
            <form>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 py-5 py-xl-5 py-xxl-7">
              <h1 class="display-3 text-1000 fw-normal">Liburan Cepat dan Mudah </h1>
              <h1 class="display-3 text-primary fw-bold">Ke Berbagai Destinasi di Indonesia</h1>
              <div class="pt-5">
                <nav>
              ...
              <div class="mx-6 mx-xl-8 my-8">
                <div class="align-items-center d-block d-flex mb-5"><img class="img-fluid me-3 me-md-2 me-lg-4" src="assets/img/icons/locations.png" alt="..." />
                  <div class="flex-1 align-items-center pt-2">
                    <h5 class="fw-bold text-light">Terbang Ke Tempat impianmu</h5>
                  </div>
                </div>
                <div class="align-items-center d-block d-flex mb-5"><img class="img-fluid me-3 me-md-2 me-lg-4" src="assets/img/icons/schedule.png" alt="..." />
                  <div class="flex-1 align-items-center pt-2">
                    <h5 class="fw-bold text-light">Rencanakan Waktumu</h5>
                  </div>
                </div>
                <div class="align-items-center d-block d-flex mb-5"><img class="img-fluid me-3 me-md-2 me-lg-4" src="assets/img/icons/save.png" alt="..." />
                  <div class="flex-1 align-items-center pt-2">
                    <h5 class="fw-bold text-light">Diskon sampai dengan 50%</h5>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Penawaran Cepat</h5>
            </div>
            <div class="col-12">
                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-md-4 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/Kute.jpg" alt="..." />
                          <div class="card-img-overlay ps-0">
                            <div class="pt-3"><span class="badge bg-primary ms-3 me-1"><i class="fas fa-clock me-1"></i><span>20:04:32:21</span></span><span class="badge bg-secondary"><i class="fas fa-bolt me-1"></i><span>trending</span><i class="fas fa-bolt ms-1"> </i></span></div>
                          </div>
                          <div class="card-body ps-0">
                            <h5 class="fw-bold text-1000 mb-4 text-truncate">Pantai Kute</h5>
                            <div class="d-flex align-items-center justify-content-start"><span class="text-800 fs--1 me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-900 me-3">Bali</span><span class="text-800 fs--1 me-2"><i class="fas fa-calendar"></i></span><span class="text-900">4 Hari</span></div>
                            <p class="text-decoration-line-through text-900 mt-3 mb-0">RP:2.0000.0000</p>
                            <h1 class="mb-3 text-primary fw-bolder fs-4"><span>RP:1.750.000</span><span class="text-900 fs--1 fw-normal">/Orang</span></h1><span class="badge bg-soft-secondary"><i class="fas fa-tag text-secondary fs--1 me-1"></i><span class="text-secondary fw-normal fs-1">-15%</span></span>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/Borobudur.jpg" alt="..." />
                          <div class="card-img-overlay ps-0">
                            <div class="pt-3"><span class="badge bg-primary ms-3 me-1"><i class="fas fa-clock me-1"></i><span>20:04:32:21</span></span><span class="badge bg-secondary"><i class="fas fa-bolt me-1"></i><span>trending</span><i class="fas fa-bolt ms-1"> </i></span></div>
                          </div>
                          <div class="card-body ps-0">
                            <h5 class="fw-bold text-1000 mb-4 text-truncate">Candi Borobudur </h5>
                            <div class="d-flex align-items-center justify-content-start"><span class="text-800 fs--1 me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-900 me-3">Magelang-Jawa Tengah</span><span class="text-800 fs--1 me-2"><i class="fas fa-calendar"></i></span><span class="text-900">4 Hari</span></div>
                            <p class="text-decoration-line-through text-900 mt-3 mb-0">RP:3.000.000</p>
                            <h1 class="mb-3 text-primary fw-bolder fs-4"><span>RP:2.500.000</span><span class="text-900 fs--1 fw-normal">/Per person</span></h1><span class="badge bg-soft-secondary"><i class="fas fa-tag text-secondary fs--1 me-1"></i><span class="text-secondary fw-normal fs-1">-15%</span></span>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/Komodo.jpg" alt="..." />
                          <div class="card-img-overlay ps-0">
                            <div class="pt-3"><span class="badge bg-primary ms-3 me-1"><i class="fas fa-clock me-1"></i><span>20:04:32:21</span></span><span class="badge bg-secondary"><i class="fas fa-bolt me-1"></i><span>trending</span><i class="fas fa-bolt ms-1"> </i></span></div>
                          </div>
                          <div class="card-body ps-0">
                            <h5 class="fw-bold text-1000 mb-4 text-truncate">Pulau Komodo</h5>
                            <div class="d-flex align-items-center justify-content-start"><span class="text-800 fs--1 me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-900 me-3">Kepulauan Sunda Kecil-NTT</span><span class="text-800 fs--1 me-2"><i class="fas fa-calendar"></i></span><span class="text-900">4 Hari</span></div>
                            <p class="text-decoration-line-through text-900 mt-3 mb-0">RP:3.750.000</p>
                            <h1 class="mb-3 text-primary fw-bolder fs-4"><span>RP:3.000.000</span><span class="text-900 fs--1 fw-normal">/Orang</span></h1><span class="badge bg-soft-secondary"><i class="fas fa-tag text-secondary fs--1 me-1"></i><span class="text-secondary fw-normal fs-1">-15%</span></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row h-100 align-items-center g-2">
                      ...
                      <div class="col-md-4 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/dhigu.png" alt="..." />
                          ...
                          <div class="card-body ps-0">
                            <h5 class="fw-bold text-1000 mb-4 text-truncate">Anantara Dhigu Resort: Uncompromising destination of luxury</h5>
                            ...
                            <h1 class="mb-3 text-primary fw-bolder fs-4"><span>$300</span><span class="text-900 fs--1 fw-normal">/Per person</span></h1><span class="badge bg-soft-secondary"><i class="fas fa-tag text-secondary fs--1 me-1"></i><span class="text-secondary fw-normal fs-1">-15%</span></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-md-4 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/maldives.png" alt="..." />
                          ...
                          <div class="card-body ps-0">
                            <h5 class="fw-bold text-1000 mb-4 text-truncate">Paradise Island Resort &amp; Spa: The best way to enjoy your vacation</h5>
                            <div class="d-flex align-items-center justify-content-start"><span class="text-800 fs--1 me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-900 me-3">Maldives</span><span class="text-800 fs--1 me-2"><i class="fas fa-calendar"></i></span><span class="text-900">4 days</span></div>
                            <p class="text-decoration-line-through text-900 mt-3 mb-0">$200</p>
                            <h1 class="mb-3 text-primary fw-bolder fs-4"><span>$175</span><span class="text-900 fs--1 fw-normal">/Per person</span></h1><span class="badge bg-soft-secondary"><i class="fas fa-tag text-secondary fs--1 me-1"></i><span class="text-secondary fw-normal fs-1">-15%</span></span>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0 h-100">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/cinnamon.png" alt="..." />
                          ...
                          <div class="card-body ps-0">
                            <h5 class="fw-bold text-1000 mb-4 text-truncate">Cinnamon Dhonveli: The sunny side of life </h5>
                            <div class="d-flex align-items-center justify-content-start"><span class="text-800 fs--1 me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-900 me-3">Maldives</span><span class="text-800 fs--1 me-2"><i class="fas fa-calendar"></i></span><span class="text-900">4 days</span></div>
                            <p class="text-decoration-line-through text-900 mt-3 mb-0">$300</p>
                            <h1 class="mb-3 text-primary fw-bolder fs-4"><span>$250</span><span class="text-900 fs--1 fw-normal">/Per person</span></h1><span class="badge bg-soft-secondary"><i class="fas fa-tag text-secondary fs--1 me-1"></i><span class="text-secondary fw-normal fs-1">-15%</span></span>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0 h-100">
      ...
      <section class="py-7 overflow-hidden" id="destinations">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              <div class="bg-primary-gradient bg-offcanvas h-100">
                <div class="row g-0 justify-content-end">
                  <div class="col-12">
                    <div class="p-6 py-md-5 px-md-3 py-lg-8 text-light"><i class="fas fa-map-marker-alt fs-5 mb-3"></i>
                      <h2 class="mb-3 text-light">Tempat Populer </h2>
                      <p>Nikmati paket kami ke tempat yang paling disukai wisatawan kami.Terjangkau, namun menyenangkan. Untuk Anda, dan keluarga Anda.  <br class="d-none d-lg-block" /> <br class="d-none d-lg-block" /></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-12 col-lg-4">
              <div class="bg-secondary-gradient h-100 d-flex align-items-center">
                <div class="text-light p-4 p-sm-6 p-lg-0 px-xxl-6">
                  <p class="fs-1 px-4 mb-6">Tidak melihat tempat yang sesuai dengan pilihan Anda? Jangan khawatir. Kami punya lebih banyak untuk Anda.</p><a class="btn btn-lg text-light fs-1 me-xl-1" href="#!" role="button">Klik untuk melihat lebih banyak
                    <svg class="bi bi-arrow-right-circle ms-xl-3" xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div class="row g-0">
            ...
            <div class="col-lg-8 bg-white">
              <div class="carousel slide" id="carouselShare" data-bs-ride="carousel">
                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100">
                      <div class="col-12"><img class="w-100" src="assets/img/gallery/dubai.png" height="600" alt="..." />
                        <div class="py-4 ps-sm-5">
                          <h4 class="mb-2 text-1000">Share a trip</h4>
                          <h2 class="mb-3 text-primary fs-3 fs-md-6">Dubai</h2>
                          <p class="fw-normal mb-0">Dubai Tourism, a hub of futuristic charm that reflects the beauty of nightlife, skyscrapers and extravagant lifestyle. Apart from this, it is also an essential destination for practising a number of adventure sports.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row h-100">
                      <div class="col-12"><img class="w-100" src="assets/img/gallery/cinnamon.png" height="600" alt="..." />
                        <div class="py-4 ps-sm-5">
                          ...
                          <p class="fw-normal mb-0">Maldives Tourism, a hub of futuristic charm that reflects the beauty of nightlife, skyscrapers and extravagant lifestyle. Apart from this, it is also an essential destination for practising a number of adventure sports.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row ps-sm-5 align-items-center">
                  ...
                  <div class="col-8 col-sm-6 position-relative z-index-2 text-end"><a class="btn btn-lg text-secondary" href="#" role="button">Baca Selengkapnya
              ...
              <div class="bg-primary-gradient h-100 bg-offcanvas-right">
                <div class="row g-0 h-100">
                  <div class="col-12 h-100">
                    <div class="d-flex flex-column justify-content-center h-100 text-light ps-4 ps-xl-5 py-5 py-lg-0"><i class="fas fa-gift fs-5 mb-3"></i>
                      <h2 class="mb-3 text-light">Paket Populer</h2>
                      <p>Enjoy our pakages to the places our travellers <br class="d-none d-xl-block" />enjoy the most. Affordable, yet enjoyable. For <br class="d-none d-xl-block" />you, and your family.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row h-100">
                  <div class="col-12">
                    <div class="d-flex flex-column flex-center h-100 text-light p-4 p-sm-6 p-md-8 p-lg-0">
                      <p class="fs-1 px-3 mb-5">Kita Mempunyai Banyak Paket Untuk Dibagikan <br class="d-none d-xl-block" />with you. Just one click away!</p><a class="btn btn-lg text-light fs-1 me-3" href="#!" role="button">Klik Untuk Melihat Selengkapnya
                        <svg class="bi bi-arrow-right-circle ms-4" xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="currentColor" viewBox="0 0 16 16">
                          <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z"></path>
                        </svg></a>
                    </div>
                  </div>
      ...
      <section class="py-7" id="activities">
        ...
        <div class="container">
          <div class="row g-0">
            <div class="col-lg-4 order-1"><img class="w-100" src="assets/img/gallery/bungee-jumping.png" height="750" alt="..." /></div>
            <div class="col-lg-8">
              <div class="carousel slide" id="carouselActivity" data-bs-ride="carousel">
                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100">
                      <div class="col-12"><img class="w-100" src="assets/img/gallery/activity.png" width="383" alt="..." />
                        <div class="py-4">
                          <h4 class="mb-2 text-1000">Engage in activities like</h4>
                          <h2 class="mb-3 text-primary fs-3 fs-md-6">Bungee Jumping</h2>
                          <p class="fw-normal mb-0 pe-lg-9">Bungee jumping involves leaping from a height connected to a large elastic rope (or cord), which is tied to the feet – or, more specifically, the ankles. This is as adrenaline- filled an activity as any dreamt up by man. And one that both young and old have delighted in</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row ps-sm-5 ps-md-0 align-items-center">
                  <div class="col-4 col-sm-6 position-relative z-index-2">
                    <ol class="carousel-indicators me-xxl-7 me-xl-4 me-lg-7">
                      <li class="active" data-bs-target="#carouselShare" data-bs-slide-to="0"></li>
                      <li data-bs-target="#carouselShare" data-bs-slide-to="1"></li>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="bg-primary-gradient h-100 d-flex align-items-end">
                <div class="row g-0 justify-content-start">
                  <div class="col-xl-9">
                    <div class="p-3 px-lg-4 text-light"><i class="fas fa-hotel fs-5 mb-3"></i>
                      <h2 class="mb-3 text-light">Explore our top Hotels</h2>
                      <p>Save on your entire order by bundling tickets with any hotel. After you add your tickets to your cart, continue the Bundle it! process by selecting the perfect hotel room. </p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="text-light py-6">
                  <div class="row g-0">
                    <div class="col-12 col-xl-6">
                      <p class="fs-1 px-3">Don’t see a place according to your choice? Don’t worry. We have more for you.</p>
                    </div>
                    <div class="col-12 col-xl-6"><a class="btn btn-lg text-light fs-1 fs-sm--1 fs-md-1 px-3" href="#!" role="button">Click to view more
      ...
      <section>
        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Travel Blogs</h5>
            </div>
            <div class="col-12">
              <div class="carousel slide" id="carouselBlogs" data-bs-ride="carousel">
                <div class="carousel-inner pb-sm-5">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/blog-1.png" alt="..." />
                          <div class="card-img-overlay d-flex flex-coloumn flex-center"></div>
                          <div class="card-body px-3 py-4">
                            <h5 class="fw-bold text-1000">10 ways to pack before a solo trip</h5>
                            <p class="text-900">As we all know our travels are not always with other people. Sometimes we have to travel for our...</p>
                          </div><a class="stretched-link" href="#!"> </a>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/blog-2.png" alt="..." />
                          <div class="card-img-overlay d-flex flex-coloumn flex-center"></div>
                          <div class="card-body px-3 py-4">
                            <h5 class="fw-bold text-1000">10 ways to pack before a solo trip</h5>
                            <p class="text-900">How fascinating is history to you? If the answer is “Yes!”, then imagine yourself on the roads of a city ce...</p>
                          </div><a class="stretched-link" href="#!"> </a>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card card-span h-100 text-white"><img class="img-fluid h-100" src="assets/img/gallery/blog-3.png" alt="..." />
                          <div class="card-img-overlay d-flex flex-coloumn flex-center"></div>
                          <div class="card-body px-3 py-4">
                            <h5 class="fw-bold text-1000">Looking for a good place?</h5>
                            <p class="text-900">Hotels are a chore to choose when it comes to travelling. Nobody wants to look for a decent place...</p>
                          </div><a class="stretched-link" href="#!"> </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselBlogs" data-bs-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="visually-hidden">Previous</span></button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselBlogs" data-bs-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="visually-hidden">Next                                    </span></button>
                  </div>
                </div>
                <div class="row flex-center">
                  <div class="col-auto position-relative z-index-2">
                    <ol class="carousel-indicators me-xxl-7 me-xl-4 me-lg-7">
                      <li class="active" data-bs-target="#carouselBlogs" data-bs-slide-to="0"></li>
                      <li data-bs-target="#carouselBlogs" data-bs-slide-to="1"></li>
                      <li data-bs-target="#carouselBlogs" data-bs-slide-to="2"></li>
                      <li data-bs-target="#carouselBlogs" data-bs-slide-to="3"></li>
                    </ol>
                  </div>
                </div>
              </div>
      ...
      <section class="py-0" id="flights">
        ...
        <div class="container-fluid">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Cheapest Flights in Popular Routs</h5>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 col-sm-4 col-lg-6">
              <div class="py-7"><img class="d-inline-block" src="assets/img/gallery/logo.png" width="50" alt="logo" /><span class="fw-bold fs-4 text-primary ms-2">GRY Plane</span>
            ...
            <div class="col-6 col-8 col-lg-6 bg-primary-gradient bg-offcanvas-right">
              <div class="p-3 py-7 p-md-7">
                <p class="text-light"><i class="fas fa-phone-alt me-3"></i><span class="text-light">+6287774133245</span></p>
                <p class="text-light"><i class="fas fa-envelope me-3"></i><span class="text-light">ghandiariza@gmail.com</span></p>
                <p class="text-light"><i class="fas fa-map-marker-alt me-3"></i><span class="text-light lh-lg">Jl. Bendungan Sutami No.188, Sumbersari, Kec. Lowokwaru, Kota Malang, Jawa Timur<br/>Indonesia</span></p>
                <div class="mt-6"><a href="#!"> <i class="fab fa-facebook text-light fs-4 me-3"></i></a><a href="#!"> <i class="fab fa-twitter text-light fs-4 me-3"></i></a><a href="#!"> <i class="fab fa-instagram text-light fs-4 me-3"></i></a></div>
              </div>
            </div>
          </div>
        </div>
